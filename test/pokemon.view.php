<main>
    <header class="header-title">
        ...
        ?>
        <!-- <h1><span><?= $pokemons[0]['nom'] ?></span> No. <?= formatNumPokemon($pokemons[0]['num_pokemon']) ?></h1> -->
    </header>
    ...
    <?php foreach ($pokemons as $pokemon) : ?>
        ...
        <div class="container caracteristics <?= $numForm == 0 ? 'active' : '' ?>" data-num-form="<?= $numForm ?>" id="pokemon-<?= $numForm ?>">
            <div class="left">
                <figure>
                    <img src="public/images/pokemon/<?= formatNumPokemon($pokemon['num_pokemon']) . ($numForm > 0 ? '_f' . ($numForm + 1) : '') ?>.png" class="img-full" />
                </figure>
                <!-- <div class="stats">
                    <h2>Stats de base</h2>
