...
<main>
    ...
    <div class="left">
        <figure>
            <img src="public/images/bieres/page_biere_seule/bieres<?= getAllBeer($Beer['reference']) . ($FormBeer > 0 ? '_f' . ($FormBeer + 1) : '') ?>.png" class="" />
        </figure>
        <figure>
            <img src="public/images/page_biere_seule/effets/<?= getAllBeer($Beer['reference']) . ($FormBeer > 0 ? '_f' . ($FormBeer + 1) : '') ?>.png" class="" />
        </figure>
    </div>
    ...
    <!-- <?php foreach ($pokemons as $pokemon) : ?>
        ...
        <div class="right">
            <figure>
                <img src="public/images/<?= getAllBeer($Beer['reference']) . ($FormBeer > 0 ? '_f' . ($FormBeer + 1) : '') ?>.png" class="" />
            </figure>
